...
import frc.robot.commands.autonomous.AutoCenterFoward;
import frc.robot.commands.autonomous.AutoCenterTakeSwitch;
import frc.robot.commands.autonomous.AutoCenterTakeSwitchClosePosition;
import frc.robot.commands.autonomous.AutoLeftRightFoward;
import frc.robot.commands.autonomous.AutoLeftTakeSwitch;
import frc.robot.commands.autonomous.AutoNothing;
import frc.robot.commands.autonomous.AutoRightTakeSwitch;
import frc.robot.subsystems.DriveTrain;
import frc.robot.subsystems.Gripper;
import frc.robot.subsystems.Pivot;
import frc.robot.subsystems.Platform;
