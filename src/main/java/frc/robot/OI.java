...
import frc.robot.commands.AbortAll;
import frc.robot.commands.DriveArcade;
import frc.robot.commands.GripperShootToSwitchLoop;
import frc.robot.commands.PlatformLock;
import frc.robot.commands.PlatformPull;
import frc.robot.commands.PlatformRelease;
import frc.robot.commands.PlatformReleaseSequence;
import frc.robot.commands.ShiftDown;
import frc.robot.commands.ShiftUp;
import frc.robot.commands.autonomous.DriveDistance;
import frc.robot.commands.autonomous.DriveFinalApproach;
import frc.robot.commands.autonomous.DriveRotate;
import frc.robot.commands.autonomous.swapmodeauto;
import frc.robot.commands.gripper.GripperClose;
import frc.robot.commands.gripper.GripperDefault;
import frc.robot.commands.gripper.GripperOpen;
import frc.robot.commands.gripper.GripperShootToSwitch;
import frc.robot.commands.pivot.PivotCustomMotion;
import frc.robot.commands.pivot.PivotToHighPosition;
import frc.robot.commands.pivot.PivotToLowPosition;
import frc.robot.commands.pivot.PivotToVerticalFromHighPosition;
import frc.robot.commands.pivot.PivotToVerticalFromLowPosition;
import frc.robot.commands.pivot.WaitForHighLimitSwitch;
import frc.robot.commands.pivot.WaitForLowLimitSwitch;
